...
//  Toast
//
//  Copyright 2015 Der-Johng Sun.
//


#import "UIView+ColorToast.h"
...
NSString const *toastBackgroundColorKey = @"toastBgColorKey";
...
@implementation UIView (ColorToast)
...
- (void)setToastBackgroundColor:(UIColor *)pToastBackgroundColor
{
    objc_setAssociatedObject(self, &toastBackgroundColorKey, pToastBackgroundColor, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (UIColor *)toastBackgroundColor
{
    return objc_getAssociatedObject(self, &toastBackgroundColorKey);
}
